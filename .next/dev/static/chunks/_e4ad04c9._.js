...
function LoginPage() {
    ...
    const handleEmailChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "LoginPage.useCallback[handleEmailChange]": (e)=>{
            setEmail(e.target.value);
            setFieldErrors({
                "LoginPage.useCallback[handleEmailChange]": (prev)=>({
                        ...prev,
                        email: []
                    })
            }["LoginPage.useCallback[handleEmailChange]"]);
    ...
    const handlePasswordChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "LoginPage.useCallback[handlePasswordChange]": (e)=>{
            setPassword(e.target.value);
            setFieldErrors({
                "LoginPage.useCallback[handlePasswordChange]": (prev)=>({
                        ...prev,
                        password: []
                    })
            }["LoginPage.useCallback[handlePasswordChange]"]);
            setGeneralError(null);
        }
    }["LoginPage.useCallback[handlePasswordChange]"], []);
    const handleLogin = async (e)=>{
        ...
        const validation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["validateLoginForm"])({
            email,
            password
        });
        if (!validation.valid) {
...
_s(LoginPage, "6+EHiwRj9mnre1mEF2+ly8a0GwE=", false, function() {
    return [
...
//# sourceMappingURL=_e4ad04c9._.js.map