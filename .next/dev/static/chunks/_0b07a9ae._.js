...
function ensureTFReady() {
    if (!tfReady) {
        tfReady = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$globals$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ready"](); // <-- AUTO selects cpu / webgl / wasm
    }
    return tfReady;
}
;
...
function triggerAlert(type) {
    const now = Date.now();
    // Don't show the same alert type too frequently
    if (type === lastAlertType && now - lastAlertTime < ALERT_COOLDOWN) {
        return;
    }
    // Play alert sound if it's a new alert
...
_s(DualVisionDemo, "YnOXxWhSch+OqaIY3tbLW7MnD98=");
_c = DualVisionDemo;
var _c;
...
//# sourceMappingURL=_0b07a9ae._.js.map