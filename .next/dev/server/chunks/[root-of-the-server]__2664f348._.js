...
async function POST(req) {
    try {
        ...
        const PRICE_MAP = {
            "price_1SdZM5FukbsOAJbKPtMJgZtH": {
                unit_amount: 500,
                product_data: {
                    name: "Vision-AI Pro (Monthly)"
                },
                recurring: {
                    interval: "month"
                }
            },
            "price_1SdZM5FukbsOAJbKNmlxe4A3": {
                unit_amount: 5000,
                product_data: {
                    name: "Vision-AI Pro (Yearly)"
                },
                recurring: {
                    interval: "year"
                }
            },
            "price_1SdZMTFukbsOAJbKxCe0z2KE": {
                unit_amount: 2000,
                product_data: {
                    name: "Vision-AI Enterprise (Monthly)"
                },
                recurring: {
                    interval: "month"
                }
            },
            "price_1SdZMnFukbsOAJbKig3R1of5": {
                unit_amount: 20000,
                product_data: {
                    name: "Vision-AI Enterprise (Yearly)"
                },
                recurring: {
                    interval: "year"
                }
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            success_url: `${("TURBOPACK compile-time value", "http://localhost:3000")}/dashboard?success=true`,
            cancel_url: `${("TURBOPACK compile-time value", "http://localhost:3000")}/?canceled=true`
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2664f348._.js.map